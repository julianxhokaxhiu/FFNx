...
if(NOT LIBPNG_FOUND)
  ...
  find_library(LIBPNG_LIBRARY libpng16 PATH_SUFFIXES lib)

  find_path(LIBPNG_INCLUDE_DIR png.h PATH_SUFFIXES include)

  add_library(LIBPNG::LIBPNG STATIC IMPORTED)

  set_target_properties(
    LIBPNG::LIBPNG
    PROPERTIES IMPORTED_LOCATION "${LIBPNG_LIBRARY}"
