...
if(NOT OPENPSF_FOUND)
  ...
  set_target_properties(
    OPENPSF::OPENPSF
    PROPERTIES IMPORTED_LOCATION "${OPENPSF_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${OPENPSF_INCLUDE_DIR}"
               INTERFACE_LINK_LIBRARIES "OPENPSF::PSXCORE;OPENPSF::PSFLIB")

  find_package_handle_standard_args(OPENPSF DEFAULT_MSG OPENPSF_PSXCORE_LIBRARY OPENPSF_PSFLIB_LIBRARY OPENPSF_LIBRARY OPENPSF_INCLUDE_DIR)
endif()
