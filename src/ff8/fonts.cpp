...
void set_font_vertices(
    ...
    float x1, float y1, float w, float h, int z,
...
void font_with_font8c_sub_4A1CF0(ff8_draw_menu_sprite_texture_infos_short *texture_infos, ff8_font *fonts)
{
    ...
    double x_related_float = (double(texture_infos->x_related) + flt_2231088)
                    * offset_menu_viewport_and_stuff_off_D8A428[4]
                    + offset_menu_viewport_and_stuff_off_D8A428[6];
    double y_related_float = (double(texture_infos->y_related) + flt_223108C)
                    * offset_menu_viewport_and_stuff_off_D8A428[5]
                    + offset_menu_viewport_and_stuff_off_D8A428[7];
    double low_word_field_10 = double(int16_t(texture_infos->field_10 >> 16));
    float width = low_word_field_10 * offset_menu_viewport_and_stuff_off_D8A428[4];
    double high_word_field_10 = double(int16_t(texture_infos->field_10 & 0xFFFF));
    uint8_t field_C_1 = texture_infos->field_C;
    float height = high_word_field_10 * offset_menu_viewport_and_stuff_off_D8A428[5];
    uint8_t field_D_1 = texture_infos->field_D;
    ...
    uint16_t field_E = texture_infos->field_E;
    int v7 = (field_E >> 6) - fonts->field_40;

    if (16 * (field_E & 0x3F) != fonts->field_3E) {
    ...
    if (2 * (texture_infos->field_4 & 0xFF) <= 255) {
        r = 2 * (texture_infos->field_4 & 0xFF);
    }
    if (2 * ((texture_infos->field_4 >> 8) & 0xFF) <= 255) {
        g = 2 * ((texture_infos->field_4 >> 8) & 0xFF);
    }
    if (2 * ((texture_infos->field_4 >> 16) & 0xFF) <= 255) {
        b = 2 * ((texture_infos->field_4 >> 16) & 0xFF);
    }
...
{
    ffnx_trace("%s: field_0=%X field_4=%X pos=(%X, %X) field_C=%X field_E=%X field_10=%X\n", __func__, texture_infos->field_0, texture_infos->field_4, texture_infos->x_related, texture_infos->y_related, *(uint16_t *)&texture_infos->field_C, texture_infos->field_E, texture_infos->field_10);
...
void fonts_with_font8c_3_sub_4A1CF0(ff8_draw_menu_sprite_texture_infos_short *texture_infos, ff8_font *fonts)
{
    ...
    *(uint16_t *)&texture_infos->field_C = 12 * (((character >> 1) % 21) | (((character >> 1) / 21) << 8));

    texture_infos->field_E = ((character & 1) ? 14418 : 14354) + ((texture_infos->field_E - 14354) << 1);
...
void fonts_field_with_font8c_sub_49C3D0(ff8_draw_menu_sprite_texture_infos_short *texture_infos_short, ff8_font *fonts)
{
    ...
    return font_with_font8c_sub_4A1CF0(texture_infos_short, fonts);
}
...
void fonts_init_2()
{
    ...
    replace_call(0x49C390 + 0xE, fonts_with_font8c_2_sub_4A1CF0); // used in field
    replace_call(0x49C3B0 + 0xB, fonts_with_font8c_3_sub_4A1CF0);

    replace_call(0x49C3D0 + 0xE, fonts_field_with_font8c_sub_49C3D0); // used in field (extended font)
...
{
    ffnx_trace("%s: field_0=%X field_4=%X pos=(%X, %X) field_C=%X field_E=%X field_10=%X\n", __func__, texture_infos->field_4, texture_infos->field_8, texture_infos->x_related, texture_infos->y_related, texture_infos->field_10, texture_infos->field_12, texture_infos->field_14);
