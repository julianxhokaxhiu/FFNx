...
bool SDLGamepad::Refresh()
{
    ...
    static const SDL_GamepadButton sdlButtons[] = {
        SDL_GAMEPAD_BUTTON_DPAD_UP_SDL,    SDL_GAMEPAD_BUTTON_DPAD_DOWN_SDL,  SDL_GAMEPAD_BUTTON_DPAD_LEFT_SDL,  SDL_GAMEPAD_BUTTON_DPAD_RIGHT_SDL,
        SDL_GAMEPAD_BUTTON_START_SDL,      SDL_GAMEPAD_BUTTON_BACK_SDL,       SDL_GAMEPAD_BUTTON_LEFT_THUMB_SDL, SDL_GAMEPAD_BUTTON_RIGHT_THUMB_SDL,
        SDL_GAMEPAD_BUTTON_LEFT_SHOULDER_SDL, SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER_SDL,
        SDL_GAMEPAD_BUTTON_A_SDL, SDL_GAMEPAD_BUTTON_B_SDL, SDL_GAMEPAD_BUTTON_X_SDL, SDL_GAMEPAD_BUTTON_Y_SDL
    };
