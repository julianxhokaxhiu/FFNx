...
inline void ff7_find_externals(struct ff7_game_obj* game_object)
{
	...
	ff7_externals.field_apply_kawai_op_64A070 = (int(*)(int, ff7_hrc_polygon_data*, ff7_kawai_opcode_params*, int, int, int, int*))get_relative_call(ff7_externals.field_animate_3d_models_6392BB, 0x726);
