...
void ff8_find_externals()
{
	...
	ff8_externals.menu_enter = get_absolute_value(ff8_externals.go_to_main_menu_main_loop, 0x19);
	ff8_externals.menu_enter2 = get_relative_call(ff8_externals.menu_enter, 0xD);
