...
1. Update your game to v1.2 ( you can find a collection here: [FF8.fr download page](https://www.ff8.fr/telechargements/programmes#archives_conserve_pour_la_posterite) )
